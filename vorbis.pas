//Copyright (c) 2017 Sean Barrett, public domain
...
{$IFDEF STB_VORBIS_DIVIDE_TABLE}
type
  Tinteger_divide_table0= array[0..DIVTAB_DENOM] of int8;
  Tinteger_divide_table1= array[0..DIVTAB_NUMER] of Tinteger_divide_table0;
var
  integer_divide_table: Tinteger_divide_table1;
{$ENDIF}
...
//            data: array of uint8; 
   ...
   function stb_vorbis_decode_filename(filename:VRBString; var channels:integer; var output:pint16):integer;
   {$ENDIF}
   {$ENDIF}
   function stb_vorbis_decode_memory(mem: array of uint8; len:integer; var channels:integer; var output:pint16; var v: Pvorb):Integer; //Xelitan MOD
   ...
   {$IFNDEF STB_VORBIS_NO_STDIO}
   function stb_vorbis_open_filename(filename:VRBString; var _error:STBVorbisError; alloc: pstb_vorbis_alloc):pvorb;
...
function vorbis_validate(data:PVRBChar):Boolean;
const
   vorbis: array [1..6] Of VRBChar = ( 'v', 'o', 'r', 'b', 'i', 's' );
begin
   ...
   if integer_divide_table[1][1]=0 then
      for i:=0 to DIVTAB_NUMER-1 do
         for j:=1 to DIVTAB_DENOM-1 do
            integer_divide_table[i][j] := (i div j);
{$ENDIF}
...
function stb_vorbis_decode_memory(mem: array of uint8; len:integer; var channels:integer; var output:pint16; var v: Pvorb):Integer;
var
